...
namespace ITSDriverApplication.DAL
{
    class ITSDriverDAL
    {
            ...
            string SupervisorEmail)
        {
            ...
            //    try
            //    {
            //        Command = new SqlCommand("SPCreateNewApplicationNew", conn, aTransaction);
            ...
            //        Command.Parameters.Add("@DriverType", SqlDbType.Int).Value = DriverType;
            //        Command.Parameters.Add("@DriverStatus", SqlDbType.Int).Value = DriverStatus;
            ...
            //        Command.Parameters.Add("@InsPolicyNumber", SqlDbType.NVarChar).Value = InsPolicyNumber;
